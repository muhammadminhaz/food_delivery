  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        final snackbar = SnackBar(content: Text('${foodItem.title} added to the cart'), duration: Duration(milliseconds: 550),);
...
class Items extends StatelessWidget {
  ...
  Items({this.leftAligned, this.imageUrl, this.itemName, this.itemPrice, this.hotel});
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        Expanded(
                          child: Text(itemName, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18),),
                        ),
                        Text('\$$itemPrice', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18),),
